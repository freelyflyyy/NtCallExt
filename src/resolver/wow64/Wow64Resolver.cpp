...
namespace NtExt {
    #ifdef _M_IX86
    DWORD64 NTAPI Wow64Resolver::_GetProcAddress64(DWORD64 hMod, const char* funcName) {
    ...
    DWORD64 Wow64Resolver::GetSyscallNumber64(DWORD64 hMod, const char* funcName) {
        if ( !hMod || !funcName ) return 0;
    ...
    DWORD64 NTAPI Wow64Resolver::GetModuleLdrEntry64(const wchar_t* moduleName) {
    ...
    DWORD64 NTAPI Wow64Resolver::GetModuleBase64(const wchar_t* moduleName) {
    ...
    VOID NTAPI Wow64Resolver::memcpy64(VOID* dest, DWORD64 src, SIZE_T sz) {
    ...
    VOID NTAPI Wow64Resolver::memcpy64(DWORD64 dest, VOID* src, SIZE_T sz) {
    ...
    DWORD64 NTAPI Wow64Resolver::LoadLibrary64(const wchar_t* moduleName) {
        if ( !moduleName ) return 0;
    ...
    DWORD NTAPI Wow64Resolver::_GetProcAddress32(DWORD hMod, const char* funcName) {
        if ( !hMod || !funcName ) return 0;
    ...
    DWORD NTAPI Wow64Resolver::GetModuleBase32(const wchar_t* moduleName) {
        if ( !moduleName ) return 0;
    ...
    DWORD NTAPI Wow64Resolver::LoadLibrary32(const wchar_t* moduleName) {
        if ( !moduleName ) return 0;
